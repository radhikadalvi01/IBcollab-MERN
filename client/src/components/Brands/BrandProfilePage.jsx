              ...
              <MDBCol lg="4">
                <MDBCard className="mb-4">
                  <MDBCardBody className="text-center">
                    ...
                    <p className="text-muted mb-4">{userData.Designation + ", " + userData.company}</p>
                ...
                <MDBCard className="mb-4 mb-lg-0">
                  <MDBCardBody>
                    <MDBRow>
                      ...
                      <MDBCol sm="9">
                        <MDBCardText className="text-muted">{userData.company}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
                    <hr />
                    <MDBRow>
                      ...
                      <MDBCol sm="9">
                        <MDBCardText className="text-muted">{userData.companyWebsite}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
                    <hr />
                    <MDBRow>
                      ...
                      <MDBCol sm="9">
                        <MDBCardText className="text-muted">{userData.companySize}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
                    <hr />
                    <MDBRow>
                      ...
                      <MDBCol sm="9">
                        <MDBCardText className="text-muted">{userData.companytype}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
                    <hr />
                    <MDBRow>
                      ...
                      <MDBCol sm="9">
                        <MDBCardText className="text-muted">{userData.industry}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
                  </MDBCardBody>
                </MDBCard>
                ...
                <MDBCard className="mb-4">
                  <MDBCardBody>
                    ...
                    <MDBRow>
                      ...
                      <MDBCol sm="9">
                        <MDBCardText className="text-muted">{userData.Designation}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
                    <hr />
                    <MDBRow>
                      ...
                      <MDBCol sm="9">
                        <MDBCardText className="text-muted">{userData.companyEmail}</MDBCardText>
                      </MDBCol>
                    </MDBRow>
                    <hr />
                    <MDBRow>
